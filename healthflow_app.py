...
def feedback_survey():
    st.markdown('<div style="font-size:16px;color:#64748B;margin-bottom:16px">Help us improve HealthFlow — this takes less than a minute. All responses are anonymous.</div>', unsafe_allow_html=True)
